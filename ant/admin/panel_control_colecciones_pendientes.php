...
if(isset($_SESSION["usr"]) ){
    ...
    <h1>Menu colecciones</h1>
        ...
        <script>
           ...
           return false; 
            ...
            function convertirReferencias(){
                $.ajax({
                       type: "POST",
                       url: "datos/conversor_referencias_colecciones_video_pdf",
                       data: $("#formConvertirColecciones").serialize(),
                       success: function(msg){
                         $("#divResultadoConversionColecciones").html(msg);
                       }
                   });
               }
        ...
        <div>Conversor entre colecciones PDF y VIDEO. Introduce referencias de video y te devolverá las referencias de los PDF's asociados a esos videos</div>
        <form id="formConvertirColecciones">
            <textarea name="texto" id="texto" cols="70" rows="8"></textarea><br> 
            <input type="button" value="Convertir" onclick="javascript:convertirReferencias();return false;">
            
        </form>
        
        
        <div id="divResultadoConversionColecciones"></div>
        <br><br>
        Colecciones pendientes: <br>
        ...
        for($i=0; $i<count($colecciones); $i++){
            ...
            $scripts='
                    ...
                    function aprobar'. $id . '(){
                        ...
                        $.ajax({
                                type: "POST",
                                url: "acciones/enviar_coleccion.php?p=8",
                                data: "id='. $id . '",
                                success: function(msg){
                    ...
                    function eliminar'. $id . '(){
                        ...
                        $.ajax({
                                type: "POST",
                                url: "acciones/enviar_coleccion.php?p=10",
                                data: "id='. $id . '",
                                success: function(msg){
                                  $("#divCentro").load("admin/panel_control_colecciones_pendientes.php");
                                }
