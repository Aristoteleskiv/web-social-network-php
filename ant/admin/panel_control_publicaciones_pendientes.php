...
if(isset($_SESSION["usr"]) ){
    ...
    <h1>Menu editor</h1>
        <br>
        <span class="boton" id="linkCrearPublicacion">Crear publicacion</span><br><br>
        Publicaciones pendientes: <br>
	...
	<tr>
        ...
        for($i=0; $i<count($publicaciones); $i++){
            ...
            $scripts='
                    ...
                    $("#iTitulo'. $id . '").click(function(){
                        ...
                        $.ajax({
                                type: "POST",
                                url: "formularios/crear_publicacion.php?p=2&a=p",
                                data: "id='. $id . '",
                    ...
                    $("#iCuerpo'. $id . '").click(function(){
                        ...
                        $.ajax({
                                type: "POST",
                                url: "formularios/crear_publicacion.php?p=3&a=p",
                                data: "id='. $id . '",
                                success: function(msg){
                                  $("#divCentro").html(msg);
                                }
                    ...
                    $("#iAyuda'. $id . '").click(function(){
                        ...
                        $.ajax({
                                type: "POST",
                                url: "formularios/crear_publicacion.php?p=4&a=p",
                                data: "id='. $id . '",
                                success: function(msg){
                                  $("#divCentro").html(msg);
                                }
                    ...
                    $("#iTipo'. $id . '").click(function(){
                        ...
                        $.ajax({
                                type: "POST",
                                url: "formularios/crear_publicacion.php?p=5&a=p",
                                data: "id='. $id . '",
                                success: function(msg){
                                  $("#divCentro").html(msg);
                                }
                    ...
                    $("#iVideo'. $id . '").click(function(){
                        ...
                        $.ajax({
                                type: "POST",
                                url: "formularios/crear_publicacion.php?p=6&a=p",
                                data: "id='. $id . '",
                                success: function(msg){
                                  $("#divCentro").html(msg);
                                }
                    ...
                    $("#iPdf'. $id . '").click(function(){
                        ...
                        $.ajax({
                                type: "POST",
                                url: "formularios/crear_publicacion.php?p=7&a=p",
                                data: "id='. $id . '",
                                success: function(msg){
                                  $("#divCentro").html(msg);
                                }
                    ...
                    function aprobar'. $id . '(){
                        ...
                        $.ajax({
                                type: "POST",
                                url: "acciones/enviar_publicacion.php?p=8&a=p",
                                data: "id='. $id . '",
                                success: function(msg){
                                  $("#divCentro").load("admin/panel_control_publicaciones_pendientes.php");
                                }
                            });
                    ...
                    function eliminar'. $id . '(){
                        if (confirm("Estas seguro de eliminar la publicacion?")) {
                            $.ajax({
                                    type: "POST",
                                    url: "acciones/enviar_publicacion.php?p=10",
                                    data: "id='. $id . '",
                                    success: function(msg){
                                      $("#divCentro").load("admin/panel_control_publicaciones_pendientes.php");
                                    }
        ...
        <script>
            $('#linkCrearPublicacion').click(function(){
                $.ajax({
                       type: "POST",
                       url: "formularios/crear_publicacion.php?p=1&a=p",
                       data: "",
                       success: function(msg){
                         $("#divCentro").html(msg);
                       }
